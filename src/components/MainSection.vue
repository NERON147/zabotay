<template>
    <section>
	 ...
	 width="24px" height="24px" viewBox="0 0 431.972 431.972" style="enable-background:new 0 0 431.972 431.972;"
	...
	<path d="M393.146,14.279c-3.713-5.333-8.713-9.233-14.989-11.707c-3.997-1.711-8.186-2.568-12.565-2.568V0H66.378
		...
		C398.71,25.507,396.852,19.609,393.146,14.279z" :class="{ filled: filled }" fill="#272E49" stroke="#715570" stroke-width="50"/>
</svg>
            </div>
    ...
    <section>
        <div class="middle-wrapper">
            ...
            <div :class="[isActive ? 'middle-wrapper_img' : 'middle-wrapper_img_toogle']">
                ...
                <button @click="dialogState = true" class="middle-wrapper_button"><img src="../assets/img/lupa.svg" alt=""></button>
                <GDialog v-model="dialogState" max-width="900">
                    ...
                    <button @click="dialogState = false" class="button close bottom-wrapper_input_btnClose_mobile">X</button>
                </GDialog>
                <button @click="toggleClass" class="middle-wrapper_button"><img src="../assets/img/none.svg" alt=""></button>
            </div>
        </div>
    </section>
        ...
        <div class="bottom-wrapper columns">
            <div class="bottom-wrapper_solving column is-6">
                    ...
                    <div class="columns is-mobile solving-mobile">
                        ...
                        <div class="column is-2">
                            <input class="bottom-wrapper_input" placeholder="0" type="text" name="" id="" v-model="form1"  ref="form1">
                        </div>
                        <div class="column is-2">
                            <img class="keyboard" src="../assets/img/keyboard.svg" alt="">
                        </div>
                        <div class="column is-2">
                            <button @click="checkForm(1)" class="bottom-wrapper_button button is-dark is-small">✓ Проверить</button>
                        </div>
                    </div>
                    ...
                    <div class="columns is-mobile solving-margin solving-mobile">
                        ...
                        <div class="column is-2">
                            <input class="bottom-wrapper_input" placeholder="0" type="text" name="" id="" v-model="form2"  ref="form2">
                        </div>
                        <div class="column is-2">
                            <img class="keyboard" src="../assets/img/keyboard.svg" alt="">
                        </div>
                        <div class="column is-2">
                            <button @click="checkForm(2)" class="bottom-wrapper_button button is-dark is-small">✓ Проверить</button>
                        </div>
                    </div>
                    <div class="bottom-wrapper_line"></div>
                    <div class="columns is-mobile solving-margin solving-mobile">
                        ...
                        <div class="column is-2">
                            <input class="bottom-wrapper_input" placeholder="0" type="text" name="" id=""  v-model="form3" ref="form3">
                        </div>
                        <div class="column is-2">
                            <img class="keyboard" src="../assets/img/keyboard.svg" alt="">
                        </div>
                        <div class="column is-2">
                            <button @click="checkForm(3)" class="bottom-wrapper_button button is-dark is-small">✓ Проверить</button>
                        </div>
                    </div>
                    <div class="bottom-wrapper_line"></div>
                        <GDialog v-model="dialogForm" max-width="500">
                            ...
                            <button @click="dialogForm = false" class="button close bottom-wrapper_input_btnClose bottom-wrapper_input_btnClose_mobile_succes">X</button>
                            </div>
                </GDialog>
    ...
    <section>
        <div class="button-wrapper">
            ...
            <button @click="answerForm = true" class="button-wrapper_btn button-wrapper_button-answer"> <span class="button-answer_x">x = </span>Посмотреть ответ</button>
            <GDialog v-model="answerForm" max-width="700">
                    <div class="wrapper">
                        <div class="content">
                            <img class="task-img_modal" src="../assets/img/answer.svg" alt="">
                    <button @click="solvingForm = true" class="button-wrapper_btn button-wrapper_button-answer"> <span class="button-answer_x">x = </span>Посмотреть решение</button>
                    <button @click="answerForm = false" class="button close bottom-wrapper_input_btnClose">X</button>
                        </div>
                    </div>
                    <GDialog v-model="solvingForm" max-width="700">
                    <div class="wrapper">
                        <div class="content">
                            <img class="task-img_modal" src="../assets/img/solving.png" alt="" style="background-color: white;">
